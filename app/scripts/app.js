...
(function () {
     ...
     * or those rendered by a server. 
     * main-region is the bulk of the page
     *  
     */
    AppName.addRegions({
    ...
    AppName.create = function( options ){
        ...
        * main-region is the bulk of the page
        * header is header of the page and not renamed 'header-region' because 
        * it's using css imported from the ArcGIS scss stack.
        *  
        */
        AppName.addRegions({
            headerRegion: '#header',
